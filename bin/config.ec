...
mudlib directory : /home/ecmud/ec

# absolute pathname of driver/config dir
binary directory : /home/ecmud/v22pre11/bin
...
default fail message : ¤°»ò¡H (½Ð¬d¸ß help)

# default message when error() occurs (optional)
default error message : [1;33m§Aµo²{¨Æ±¡¤£¤j¹ï¤F¡M¦ý¬O¤S»¡¤£¤W¨Ó¡C[2;37;0m

# the external commands we support
external_cmd_1: /usr/local/bin/cdict
